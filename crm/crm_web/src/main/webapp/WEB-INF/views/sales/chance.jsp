                ...
                <div class="box-body no-padding">
                    <table class="table">
                        <tr>
                            ...
                            <td>${saleChance.customer.position}</td>
                            <td class="td_title">联系电话</td>
                            <td>${saleChance.customer.mobile}</td>
                        </tr>
                        <tr>
                            <td class="td_title">所属行业</td>
                            <td>${saleChance.customer.industry}</td>
                        ...
                        <c:if test="${not empty saleChance.customer.remark}">
                            <tr>
                                <td class="td_title">备注</td>
                                <td colspan="5">${saleChance.customer.remark}</td>
                            </tr>
                        </c:if>
                    </table>
                </div>
