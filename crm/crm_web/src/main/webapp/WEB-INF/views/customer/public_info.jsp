            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        ...
                        <a href="/customer/public/${customer.id}/edit" class="btn bg-purple btn-sm"><i class="fa fa-pencil"></i> 编辑</a>
                        <button id="tranBtn" class="btn bg-orange btn-sm"><i class="fa fa-exchange"></i> 抢入客户</button>
    ...
    $(function () {
        ...
        $("#delBtn").click(function () {
            ...
            layer.confirm("删除客户会自动删除相关数据，确定吗?",function(){
                window.location.href = "/customer/public/"+id+"/del";
            });
        });
        /*//放入公海
