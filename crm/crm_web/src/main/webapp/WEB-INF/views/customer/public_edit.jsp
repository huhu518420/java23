            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="/customer/public/${customer.id}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回客户详情</a>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="industry">
                                ...
                                <c:forEach items="${industryList}" var="industry">
                                    <option value="${industry}" ${customer.industry == industry ? 'selected' : ''}>${industry}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
